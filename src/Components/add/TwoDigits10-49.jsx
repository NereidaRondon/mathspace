...
export default function TwoDigits(){
  ...
  function NumsGenerator(){
    ...
    let TopRow1 = Math.floor(Math.random() * 4) + 1;
    let TopRow2 = Math.floor(Math.random() * 9) + 1;
    let BottomRow1 = Math.floor(Math.random() * 4) + 1;
    let BottomRow2 = Math.floor(Math.random() * 9);
